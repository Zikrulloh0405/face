...
#     cv2.fillConvexPoly(mask, np.int32(tri2_rect_int), 1.0, 16, 0)
#
...
# # List of images
#
# image_filenames = ["firai.jpg", "khadisha.jpg", "mirai.jpg","hamid.jpg"]
#
# all_landmarks = []
...
# average_img = np.zeros_like(preprocess_image(image_filenames[0]), dtype=np.float64)
#
...
#     print(i, image_path)
#     img = preprocess_image(image_path)
#     warped_img = np.zeros_like(img, dtype=np.float64)
#
...
# average_img = sum_img / len(image_filenames)
